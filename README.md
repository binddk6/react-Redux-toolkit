...
Here we have tried to build a project implementing redux tech using redux where add to cart function dispatching the data to redux store also we are fetching the data using redux thunk and displaying it to products page
